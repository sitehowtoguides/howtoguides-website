...
export default function MidjourneyGuide() {
  ...
  return (
    <div>
            ...
            {currentModule > 2 && (
              <div className="locked-content">
                ...
                <LeadCaptureForm 
                  ...
                  description="Join thousands of AI enthusiasts who have mastered Midjourney with our comprehensive guide."
      ...
      {showPopup && (
        <LeadCapturePopup 
          title="Want to Master Midjourney?"
          description="Get our complete guide with advanced techniques, prompt templates, and expert tips!"
